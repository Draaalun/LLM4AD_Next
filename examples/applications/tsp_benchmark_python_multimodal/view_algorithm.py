"""View TSP algorithm behavior with automatic storage-mode detection.
...
EVALUATOR_SCRIPT = EXAMPLE_DIR / "tsp_evaluator.py"
DATASET_DIR = EXAMPLE_DIR / "data" / "small"
PROJECT_ROOT = EXAMPLE_DIR / "tsp_algorithm"

"""Debug entry point for LunarLander benchmark pipeline.
...
Set breakpoints in VSCode at key locations:
    ...
    - lunarlander_evaluator_optimized.py:232   (evaluate entry)
"""
...
async def main():
    """Run the full LLM4AD pipeline for the LunarLander task."""
